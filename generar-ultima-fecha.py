...
mine_last={('Czechia','Mexico'):(1,2),('South Africa','South Korea'):(0,2),('Switzerland','Canada'):(1,1),('Bosnia and Herzegovina','Qatar'):(2,0),('Scotland','Brazil'):(0,2),('Morocco','Haiti'):(2,0),('Turkiye','United States'):(1,2),('Paraguay','Australia'):(0,1),('Curacao','Ivory Coast'):(0,3),('Ecuador','Germany'):(1,2),('Japan','Sweden'):(3,1),('Tunisia','Netherlands'):(0,3),('Egypt','Iran'):(5,1),('New Zealand','Belgium'):(0,2),('Cape Verde','Saudi Arabia'):(1,0),('Uruguay','Spain'):(1,2),('Norway','France'):(1,2),('Senegal','Iraq'):(2,0),('Algeria','Austria'):(0,0),('Jordan','Argentina'):(0,3),('Colombia','Portugal'):(1,2),('DR Congo','Uzbekistan'):(1,1),('Panama','England'):(0,3),('Croatia','Ghana'):(1,0)}
...
matches=[
 ...
 ('Sab 27-jun','Argelia','Austria','1.1-1.7','0-1','0-0',1,'TU PICK: empate 0-0 (ambos ya con un pie adentro, parten dividiendo). Real: 3-3.'),
 ('Sab 27-jun','Jordania','Argentina','0.2-4.0','0-4','0-3',1,'TU PICK: Argentina 3-0 (1a ya asegurada, gana comodo a una Jordania eliminada). Real: 3-1.'),
