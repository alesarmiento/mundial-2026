...
mine_last={('Czechia','Mexico'):(1,2),('South Africa','South Korea'):(0,2),('Switzerland','Canada'):(1,1),('Bosnia and Herzegovina','Qatar'):(2,0),('Scotland','Brazil'):(0,2),('Morocco','Haiti'):(2,0),('Turkiye','United States'):(1,2),('Paraguay','Australia'):(0,1),('Curacao','Ivory Coast'):(0,3),('Ecuador','Germany'):(1,2),('Japan','Sweden'):(3,1),('Tunisia','Netherlands'):(0,3),('Egypt','Iran'):(0,1),('New Zealand','Belgium'):(0,2),('Cape Verde','Saudi Arabia'):(1,0),('Uruguay','Spain'):(0,2),('Norway','France'):(1,2),('Senegal','Iraq'):(2,0),('Algeria','Austria'):(0,1),('Jordan','Argentina'):(1,2),('Colombia','Portugal'):(1,2),('DR Congo','Uzbekistan'):(1,0),('Panama','England'):(0,3),('Croatia','Ghana'):(1,0)}
...
ana={'A':'CERRADO (real): Mexico 1o, Sudafrica 2o. Corea 3a con 3 pts -> ENTRA como mejor tercero. Chequia afuera.','B':'CERRADO (real): Suiza 1o (gano 2-1), Canada 2o. Bosnia 3o con 4 pts (goleo 3-1 a Catar) -> VIVO.','C':'CERRADO (real): Brasil 1o (3-0), Marruecos 2o (4-2). Escocia 3a pero perdio 0-3 -> SE CAE del corte.','D':'USA 1ro. Australia el 2do mas seguro (DG 0). Con tu Australia 0-1, Australia queda en tus 32 (clasificado seguro) y Paraguay 3o al volado. Se juega HOY.','E':'Alemania 1ro, C.Marfil 2do (vivo). Ecuador (1pt) sigue en TUS 32: +7 si DA LA SORPRESA y le gana a Alemania rotada, pero pronosticamos Alemania 2-1 (lo mas real). Se juega HOY.','F':'PaisesBajos y Japon adentro. Suecia 3a: con tu Japon 3-1 cae a 3a pero sostiene mejor-tercero. Se juega HOY.','G':'Con tu Iran 1-0: Iran y Belgica se quedan 1o/2o, Egipto cae a 3o pero igual clasifica (4 pts). Los TRES adentro -> Iran (que es tuyo) suma +7.','H':'Espana 1a. Con tu Cabo Verde 1-0, CV sube a 2do y clasifica directo; Uruguay 3o afuera.','I':'Francia, Noruega, Senegal: los 3 VIVOS.','J':'Argentina, Austria, Argelia: los 3 VIVOS.','K':'Colombia y Portugal; sin tercero clasificado.','L':'Inglaterra y Croacia. Te falta Ghana.'}
...
matches=[
 ...
 ('Vie 26-jun','Egipto','Iran','1.2-1.3','0-1','0-1',0,'TU PICK: gana Iran 1-0. Egipto NO se juega nada (ya clasificado 100%) e Iran pelea la vida -> el modelo da a Iran favorito (40%) y es el marcador de mayor valor esperado (2.98). Ademas Iran esta en TU cuadro: si clasifica te suma +7, y desplaza a Argelia (que no es tuya). Win-win.'),
