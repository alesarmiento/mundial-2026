...
mine_last={('Czechia','Mexico'):(1,2),('South Africa','South Korea'):(0,2),('Switzerland','Canada'):(1,1),('Bosnia and Herzegovina','Qatar'):(2,0),('Scotland','Brazil'):(0,2),('Morocco','Haiti'):(2,0),('Turkiye','United States'):(1,2),('Paraguay','Australia'):(0,1),('Curacao','Ivory Coast'):(0,3),('Ecuador','Germany'):(1,2),('Japan','Sweden'):(3,1),('Tunisia','Netherlands'):(0,3),('Egypt','Iran'):(2,1),('New Zealand','Belgium'):(0,2),('Cape Verde','Saudi Arabia'):(1,0),('Uruguay','Spain'):(0,2),('Norway','France'):(1,2),('Senegal','Iraq'):(2,0),('Algeria','Austria'):(0,1),('Jordan','Argentina'):(1,2),('Colombia','Portugal'):(2,1),('DR Congo','Uzbekistan'):(1,0),('Panama','England'):(0,3),('Croatia','Ghana'):(1,0)}
...
matches=[
 ...
 ('Vie 26-jun','Egipto','Iran','1.2-1.3','0-1','2-1',1,'TU PICK: Egipto 2-1 (los viste jugar muy bien). Egipto ya esta clasificado (100%), asi que este marcador es LIBRE para tu cuadro. El modelo lo ve parejo (33/27/40, leve favorito Iran), pero tu lectura manda: Egipto gana y sella el 1o; Iran al 3o.'),
 ...
 ('Sab 27-jun','Colombia','Portugal','1.6-1.4','2-1','2-1',0,'Ambos por el 1o; EV-max Colombia 2-1'),
