...
`scoring_modelo_desde=2026-06-11`). El marcador se puntua con el **mismo marcador que se muestra**
(redondeo del xG): lo que se ve en Por fecha es lo que se puntua.
